...
def draw_curve_5_points(p3, p1, p2, p4, p5):
    draw_big_point(p1)
    draw_big_point(p2)
    draw_big_point(p3)
    draw_big_point(p4)
    ...
    for i in range(0, 100, 2):
        ...
        x = ((-t ** 3 + 2 * t ** 2 - t) * p2[0] + (3 * t ** 3 - 5 * t ** 2 + 2) * p3[0] + (
                -3 * t ** 3 + 4 * t ** 2 + t) * p4[0] + (t ** 3 - t ** 2) * p4[0]) / 2
...
p1 = x1, y1 = random.randint(000, 200), random.randint(000, 200)
...
#draw_curve_4_points(p1, p3, p4, p2)
draw_curve_5_points(p1, p2, p3, p4, p5)
